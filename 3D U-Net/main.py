...
def configure():
    ...
    flags.DEFINE_integer('save_interval', 500, '# of interval to save model')
    ...
    flags.DEFINE_integer('patch_size', 512, 'patch size')
    ...
    flags.DEFINE_integer('height', 512, 'height size') # should be equal to patch_size
    flags.DEFINE_integer('width', 512, 'width size') # should be equal to patch_size
    # Debug
    ...
    flags.DEFINE_integer('test_step', 93500, 'Test or predict model at this step')
